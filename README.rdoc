...
[ I'M HERE ]
     When note is added as 1st move in list, td count in move table is wrong?
     Fix styling of table of moves
     ...
     Add notes field
     Notify player when a all but 1 cell for a combo of options is x'd out?
