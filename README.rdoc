...
x.   Add row & column #'s
===>>> I'm here
     When move is made, update view, then post to server
     Add button to clear board
     When hovering over a cell, highlight its row & column
...
* Add a way to mark off a block of moves, e.g. "initial pass"